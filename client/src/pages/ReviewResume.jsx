    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4
        text-state-700'>
            ...
            border-gray-200'>
              ...
              <input onChange={(e)=>setInput(e.target.files[0])} value={input} type='file' accept='application/pdf' className='w-full p-2 px-3 mt-2 outline-none text-sm
              ...
              bg-gradient-to-r from-[#00DA83] to-[#0088B3] text-white px-4
            ...
            border-gray-200 min-h-96 max-h-[600px]'>
...

              {
                ...
                :
                (
                  <div className='mt-3 h-full overflow-y-scroll te-sm text-slate-600'>

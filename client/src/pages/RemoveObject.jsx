    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4
        text-state-700'>
            ...
            border-gray-200'>
              ...
              rounded-md border border-gray-300' placeholder='e.g. watch or spoon, only singla object name' required/>
    
              <button disabled={loading} className='w-full flex items-center justify-center gap-2
              bg-gradient-to-r from-[#417DF6] to-[#BE37EB] text-white px-4

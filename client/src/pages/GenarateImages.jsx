...
const GenarateImages = () => {
  
     const imageStyle = ['Realistic', 'Ghibil style', 'Anime style', 
'Cartoon style', 'Fantasy style', 'Realistic style', '3D style', 'Porttrait style'     ]
        ...
        text-state-700'>
            ...
            border-gray-200'>
              <div className='flex items-center gap-3'>
                <Sparkles className='w-6 text-[#00AD35]'/>
              ...
              rounded-md border border-gray-300' placeholder='Describe what you want to see in image...' required/>

  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
        <div className='text-center'>
            <h2 className='text-state-7 text-[42px] font-semibold'>Powerul AI Tools</h2>
            <p className='text-gray-500 ax-w-lg mx-auto'>dj ckgjdkcsksmlc jnjggmv gjtudoska djnd dhjrmi
                jjnfs jdjndk oeewk 
            </p>
        </div>

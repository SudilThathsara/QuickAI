    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
                Experiance the power o AI with QuickAI. <br />
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Incidunt ducimus reiciendis odit corrupti magni ad, dicta vitae nobis! Dolor, officiis? Earum ullam reiciendis vitae distinctio quas tempora quisquam quaerat iusto.
            </p>
        </div>
